...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        for ($i = 0; $i < 100; $i++) {
            ...
            QrCode::format('png')->merge(public_path('td-logo.png'), .3, true)->style('round')->eye('circle')->color(41, 79, 179)->size(600)->generate(''.$userData['provider_id'].'', public_path('images/qrcodes/'.$userData['email'].'.png'));
